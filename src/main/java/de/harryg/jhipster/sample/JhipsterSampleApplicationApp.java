package de.harryg.jhipster.sample;

import de.harryg.jhipster.sample.config.ApplicationProperties;
import de.harryg.jhipster.sample.config.DefaultProfileUtil;
